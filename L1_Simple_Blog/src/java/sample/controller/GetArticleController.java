...
public class GetArticleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ArticleDTO> listArticleDTOs = articleDAO.getAllArticle();
            if(listArticleDTOs.size() > 0) {
                request.setAttribute("LIST_ALL_ARTICLE", listArticleDTOs);
                url = SUCCESS;
            }
        } catch (Exception e) {
            log("Error at GetArticleController: " + e.toString());
        } finally {
