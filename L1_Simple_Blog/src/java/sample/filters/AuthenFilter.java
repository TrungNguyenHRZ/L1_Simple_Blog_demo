...
public class AuthenFilter implements Filter {
    ...
    private static final String ROLE_AD = "admin";
    private static final String ROLE_MEM = "member";
    private static List<String> ADMIN_FUNCTIONS;
    private static List<String> MEMBER_FUNCTIONS;
    ...
    public AuthenFilter() {
        MEMBER_FUNCTIONS = new ArrayList<>();
        MEMBER_FUNCTIONS.add("member.jsp");
        MEMBER_FUNCTIONS.add("postArticle.jsp");
        ...
        NON_AUTHEN_FUNCTIONS.add("article.jsp");
        ...
        NON_AUTHEN_FUNCTIONS.add("register.jsp");
        NON_AUTHEN_FUNCTIONS.add("articleDetail.jsp");
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            //xác thực
            AccountDTO account = (AccountDTO) session.getAttribute("LOGIN_ACC");
            if (session == null || account == null) {
                res.sendRedirect(LOGIN_PAGE);
            } else {
                String role = account.getRole();
                //phân quyền
                if (ROLE_AD.equals(role) && ADMIN_FUNCTIONS.contains(resource)) {
                    chain.doFilter(request, response);
                } else if (ROLE_MEM.equals(role) && MEMBER_FUNCTIONS.contains(resource)) {
                    chain.doFilter(request, response);
                } else {
                    res.sendRedirect(LOGIN_PAGE);
                }
